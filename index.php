...
$app->get('/servicos/{disp}/{servico}/{script}', function($req, $res, $args) {
	...
	$query = "SELECT arquivo_final FROM arquivos_teste INNER JOIN servicos ON arquivos_teste.servico = servicos.nome_servico WHERE servico = '$servico' arquivos_teste.script = '$script' AND arquivos_teste.download = 'N' AND servico_disp = '1' LIMIT 1;";
	$result = $mysqli->query($query);
